...
// tetris
const int note1[] = {NOTE_E5, NOTE_B4, NOTE_C5, NOTE_D5, NOTE_C5, NOTE_B4, NOTE_A4, NOTE_A4, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_B4, NOTE_C5, NOTE_D5, NOTE_E5, NOTE_C5, NOTE_A4, NOTE_A4, NOTE_A4, NOTE_B4, NOTE_C5, NOTE_D5, NOTE_F5, NOTE_A5, NOTE_G5, NOTE_F5, NOTE_E5, NOTE_C5, NOTE_E5, NOTE_D5, NOTE_C5, NOTE_B4, NOTE_B4, NOTE_C5, NOTE_D5, NOTE_E5, NOTE_C5, NOTE_A4, NOTE_A4, REST, NOTE_E5, NOTE_C5, NOTE_D5, NOTE_B4, NOTE_C5, NOTE_A4, NOTE_GS4, NOTE_B4, REST, NOTE_E5, NOTE_C5, NOTE_D5, NOTE_B4, NOTE_C5, NOTE_E5, NOTE_A5, NOTE_GS5};
const byte duration1[] = {4, 8, 8, 4, 8, 8, 4, 8, 8, 4, 8, 8, -4, 8, 4, 4, 4, 4, 8, 4, 8, 8, -4, 8, 4, 8, 8, -4, 8, 4, 8, 8, 4, 8, 8, 4, 4, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 2, 4, 8, 2, 2, 2, 2, 4, 4, 2, 2};
const byte repeat1[] = {41, 0, 0, 0};
...
// greenhill
const int note2[] = {REST, NOTE_D5, NOTE_B4, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_A4, NOTE_FS5, NOTE_E5, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_D5, NOTE_B4, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_B4, NOTE_B4, NOTE_G4, NOTE_B4, NOTE_A4, NOTE_B4, NOTE_A4, NOTE_D4, REST, NOTE_D5, NOTE_B4, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_A4, NOTE_FS5, NOTE_E5, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_D5, NOTE_B4, NOTE_D5, NOTE_CS5, NOTE_D5, NOTE_CS5, NOTE_A4, REST, NOTE_B4, NOTE_B4, NOTE_G4, NOTE_B4, NOTE_A4, NOTE_B4, NOTE_A4, NOTE_D4, NOTE_D4, NOTE_FS4, NOTE_E4, REST, NOTE_D4, NOTE_E4, NOTE_FS4, REST, NOTE_D4, NOTE_D4, NOTE_FS4, NOTE_F4, REST, NOTE_D4, NOTE_F4, NOTE_E4};
const byte duration2[] = {2, 8, 4, 8, 4, 8, 4, 2, 8, 8, 8, 4, 8, 4, 8, 4, 2, 4, 8, 4, 8, 4, 8, 4, 2, 8, 8, 8, 4, 8, 4, 8, 4, 2, 4, 8, 4, 8, 4, 8, 4, 2, 8, 8, 8, 4, 8, 4, 8, 4, 2, 4, 8, 4, 8, 4, 8, 4, 2, 8, 8, 8, 4, 8, 4, 8, 4, 8, 8, 8, -1, 8, 8, 8, -1, 8, 8, 8, 8, -1, 8, 8, 8, -1};
const byte repeat2[] = {84, 0, 0, 0};
...
void attPlayMusic() {
  ...
  if (currentDuration <= 0) {
    ...
    if (thisNote == repeats[notesRepeatPos]) {
      thisNote = repeats[notesRepeatPos + 1];
      notesRepeatPos += 2;
    }
    ...
    tone(BUZZER_PIN, notes[thisNote], noteDuration * 0.9);
